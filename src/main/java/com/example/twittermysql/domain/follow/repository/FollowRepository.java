package com.example.twittermysql.domain.follow.repository;
...
public class FollowRepository {
    ...
    private Follow insert(Follow follow) {
        ...
        return Follow.builder().id(id).fromMemberId(follow.getFromMemberId())
                .toMemberId(follow.getToMemberId()).createdAt(follow.getCreatedAt()).build();
    }
