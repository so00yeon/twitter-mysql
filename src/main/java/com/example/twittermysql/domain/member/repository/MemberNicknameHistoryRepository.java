package com.example.twittermysql.domain.member.repository;
...
public class MemberNicknameHistoryRepository {
    ...
    private MemberNicknameHistory insert(MemberNicknameHistory history) {
        ...
        return MemberNicknameHistory.builder().id(id).memberId(history.getMemberId())
                .nickname(history.getNickname()).createdAt(history.getCreatedAt()).build();
    }
}
